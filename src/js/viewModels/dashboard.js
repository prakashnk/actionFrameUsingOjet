    ...
    function(oj, ko, $) {
        function DashboardViewModel() {
            ...
            self.columnArray = [{
                ...
                {
                    "headerText": "Lead Number",
                    "sortable": "enabled",
                    "field": "LeadNumber",
                    "renderer": oj.KnockoutTemplateUtils.getRenderer("leadNumber", true),
                    "sortProperty": "LeadNumber"
                },
                {
                    "headerText": "Deal Amount",
                    "renderer": oj.KnockoutTemplateUtils.getRenderer("dealAmount", true),
                    "field": "DealAmount",
                    "sortProperty": "DealAmount"
                },
                {
                    "headerText": "Status",
